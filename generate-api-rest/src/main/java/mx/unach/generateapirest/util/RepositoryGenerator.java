...
public class RepositoryGenerator {
    ...
    public StringBuilder repository(ClaseModel claseModel) {
        ...
        codeBuilder.append("@Repository(\"").append(StringUtils.firstLetterToLowerCase(nameClass)).append("Repository").append("\")\n");

        codeBuilder.append("public interface ").append(nameClass).append("Repository").append(" extends CrudRepository<").append(nameClass).append("Entity").append(", ").append(claseModel.getAttributeModel().getTypePK()).append(">{\n\n");
