...
export class InicioComponent {
  ...
  submitForm() {
    const form = document.querySelector('form'); // Busca el formulario en el DOM
    form!.dispatchEvent(new Event('submit')); // Dispara un evento de envío de formulario
    var forms = document.querySelectorAll('.needs-validation')
  ...
  @ViewChild(TablaForaneosComponent) tablaForaneosComponent!: TablaForaneosComponent; // Referencia al componente hijo
